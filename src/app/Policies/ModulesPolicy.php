...
class ModulesPolicy
{
    ...
    {
        return $user->can('view_any_modules');
    }
    ...
    {
        return $user->can('create_modules');
    }
    ...
    {
        return $user->can('update_modules');
    }
    ...
    {
        return $user->can('delete_modules');
    }
    ...
    {
        return $user->can('delete_any_modules');
    }
